...
exports.jsonErrPass = exports.errPass = undefined;
...
function errPass(data, empty, usePosition) {
  if ((typeof data === 'undefined' ? 'undefined' : _typeof(data)) !== (typeof empty === 'undefined' ? 'undefined' : _typeof(empty)) || empty === null || typeof data === 'undefined') return usePosition ? (0, _unit.errorLog)('数据和期望的数据不一致', usePosition, empty) : empty;
  if (typeof empty === 'number' && isNaN(data)) return usePosition ? (0, _unit.errorLog)('数据和期望的数据不一致', usePosition, empty) : empty;
  if ((typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object') {
    var isArrayOfData = data instanceof Array;
    var isArrayOfEmpty = empty instanceof Array;
    if (isArrayOfData !== isArrayOfEmpty) return usePosition ? (0, _unit.errorLog)('数据和期望的数据不一致', usePosition, empty) : empty;
    // return data;
  }
  return data;
}
...
exports.jsonErrPass = jsonErrPass;